...
namespace CodeBucket.Controllers
{
    public class SettingsViewController : BaseDialogViewController
    {
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            root.Add(new Section(string.Empty, "If disabled, CodeBucket will prompt you for your password when you switch to this account".t()) {
            ...
            root.Add(new Section(string.Empty, "If enabled, your teams will be shown in the CodeBucket slideout menu under Events".t()) {
