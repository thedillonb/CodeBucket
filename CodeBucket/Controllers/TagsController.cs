...
{
    public class TagsController : Controller<List<TagsController.TagModel>>
    {
        private readonly string _username;
        private readonly string _slug;

        public TagsController(IView<List<TagsController.TagModel>> view, string username, string slug)
            : base(view)
        {
            _username = username;
            _slug = slug;
